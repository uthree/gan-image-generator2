...
trainer.train(dataset=dataset, initial_batch_size=40, num_epochs_per_resolution=200, max_resolution=1024, learning_rate=1e-4, save_path=model_path, results_dir_path='results/', augmentor=augmentor)